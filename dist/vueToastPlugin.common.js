...
Toast.install = function (Vue, options) {
  ...
  if (!tplIntance) {
    ...
    var tpl = tplIntance.$el;
    document.body.appendChild(tpl);
  }

  Vue.prototype.$toast = function (tips) {
    var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : opt,
        type = _ref.type,
  ...
  ["success", "primary", "warining", "danger", "info", 'loading'].forEach(function (type) {
    Vue.prototype.$toast[type] = function (tips) {
      var duration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : opt.duration;
  ...
  Vue.prototype.$toast.clear = function () {
    tplIntance.clear();
  };
};

/* harmony default export */ var lib = (Toast);
...
/******/ });
//# sourceMappingURL=vueToastPlugin.common.js.map